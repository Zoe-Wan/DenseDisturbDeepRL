...
class KinematicObservation(ObservationType):
    ...
    FEATURES_acc_training = ['x', 'lane_id', 'v']
    ...
    def __init__(self, env, features=FEATURES, vehicles_count=5, **kwargs):
        ...
        self.features_acc_training = self.FEATURES_acc_training
    ...
    def original_observe_acc_training(self, cav_obs_num=10, cav_observation_range=100):
        """
        Obtain AV observation.

        Args:
            cav_obs_num: AV maximum number of observations.
        ...
        """
        # Add ego-vehicle
        df = pandas.DataFrame.from_records([self.env.vehicle.to_dict_acc_training()])[self.features_acc_training]
        # Add nearby traffic, given range and maximum number of BV
